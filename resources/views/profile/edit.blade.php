                        ...
                        <div class="grid gap-6 grid-cols-1 md:grid-cols-3 md:grid-rows-1">
                            ...
                            <div class="mb-6">
                                <label for="blood_group"
                                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Blood Group *
                                </label>
                            ...
                            <div class="flex mb-6">
                                ...
                                <div class="ml-2 text-sm">
                                    <label for="helper-checkbox"
                                        class="font-medium text-gray-900 dark:text-gray-300">Are you willing to donate
                                        blood ?</label>
